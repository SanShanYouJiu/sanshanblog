...
public enum PosCodeEnum {
    ...
    OK(0,"SUCCESS"),NOT_FOUND(404,"不存在"),Email_EXIST(20001,"该邮箱已存在"),USERNAME_NOALLOW(20002,"用户名不合法"),EMAIL_NOALLOW(20003,"邮箱名不合法"),CODE_ERROR(20004, "验证码错误"),
    ...
    PARAM_ERROR(20014,"错误的参数值"), INTER_ERROR(20015, "内部错误"),FREQUENTLY_REQUEST(20016,"请求太频繁"),UNKONW_EXCEPTION(20017,"未知错误")
    ;
